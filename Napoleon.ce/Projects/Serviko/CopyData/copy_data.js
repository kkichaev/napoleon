...
var objects = ["AgentQuest", 'Attachment', "ColorsTable", "Division", "DivisionManager", 'LicensedUsers', 'ManagerConfig', 'OrgLocation', 'OrgStop', 'PricePhotoCopy', 'SyncInfo', 'UserActivity', 'UserInfo'];

var filterObjects = ['AgentMatrix', 'AgentOrgTask', 'AgentScript', 'OrgFolder', 'OrgTask', 'PotenzialOrg', 'ServerConfig'];
