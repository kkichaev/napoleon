      ...
      if r.id in orgs:
        ...
        for ri in r.items:
          if ri.id in price:
            ...
            if ri.qty > 0 and p.docFilter == 1 and p.season == 2:
              putRemnant(r, summer, org.typepttID, ri)

            if ri.qty > 0 and p.docFilter == 1 and p.season == 2 and p.diameter in [17,18]:
              putRemnant(r, d17_18_summer, org.typepttID, ri)
  
            if ri.qty > 0 and p.docFilter == 1 and p.season == 1:
              putRemnant(r, winter, org.typepttID, ri)              
              
            if ri.qty > 0 and p.docFilter == 1 and p.season == 1 and p.diameter in [17,18]:
              putRemnant(r, d17_18_winter, org.typepttID, ri)
              
            if ri.qty > 0 and p.docFilter == 1 and p.autoType == 'ЛГШ':
