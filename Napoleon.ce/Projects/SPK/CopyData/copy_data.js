...
var createdDocs = ["CopyIncass", "CopyOrder", "CopyOrgRemnants", 'CopyReturns', 'Answer', 'CopyPlanRoute', 'CopyLayout'];
var dateDocs = ["CopyGPSPos", 'CopyUserLog'];
var objects = ["AgentMatrix", "ColorsTable", "Division", "DivisionManager", 'PotenzialOrg', 'SyncInfo', 'UserInfo','LayoutApproveLog'];

var filterObjects = ['ServerConfig', 'AgentQuest', 'OrgDisablePhoto'];
