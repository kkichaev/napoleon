...
class Item:
  __slots__ = ["address", "org", "created", "user", "items"]
  ...
  def values(self):
    res = [self.org, self.address, self.created.strftime('%d.%m.%Y'), self.user]
...
def printOut(data, params):
    ...
    r = 2
    arr = ["Наименование", "Адрес", "Дата", "Торговый представитель"]
