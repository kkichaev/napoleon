...
public:
   ...
   void Add(bool response, const std::wstring& message, const wchar_t* kind = L"");
};
...
public:
   ...
   enum UserVersionActions { Warning = 0, Forbidden, None };
   ...
   void AddAnswer(bool response, const std::wstring& message, const wchar_t* kind = L"");
...
protected:
   ...
   UserVersionActions GetUserUpdateAction(const User& user);
