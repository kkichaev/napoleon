...
typedef bool (*TSymHandler)(wchar_t sym, Token *dest, StringStream &stream, const SessionObject* object, IResolver &resolver, const wchar_t *endStmt, bool needDebug);
bool SymbolHandler(wchar_t sym, Token *dest, StringStream &stream, const SessionObject* object, IResolver &resolver, const wchar_t *endStmt, bool needDebug);
bool ParseStr(Token *dest, StringStream &stream, const SessionObject* thisObject, IResolver &resolver, const wchar_t *endStmt = L"", bool needDebug = false, TSymHandler = SymbolHandler);
