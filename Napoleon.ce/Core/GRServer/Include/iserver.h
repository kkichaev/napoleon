...
public:
   ...
   virtual const char* UpdateFolder() const = 0;
   virtual const char* PluginsFolder() const = 0;
...
struct IServer : public IErrorLogger
{
   ...
   //
   // ------------- требуется для update ---------------
   //
   // начинаем останавливать модуль, когда остановится, мутекс освобождается
