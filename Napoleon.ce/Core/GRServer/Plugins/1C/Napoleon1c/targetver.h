...
#define WINVER 0x0500           // Выберите значение, указывающее на другие версии Windows.
#endif

#ifndef _WIN32_WINNT            // Указывает, что минимально необходимой версией платформы является Windows Vista.
#define _WIN32_WINNT 0x0500     // Выберите значение, указывающее на другие версии Windows.
#endif
...
#define _WIN32_IE 0x0500        // Выберите значение, указывающее на другие версии Internet Explorer.
#endif
