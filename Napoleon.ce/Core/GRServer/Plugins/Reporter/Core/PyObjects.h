...
struct PyCurl
{
	...
	bool Do(bool getUrl, const char* url, PyObject* headers, PyObject* postData, PyObject* fileData);
	bool Put(const char*url, PyObject* headers, const char* data);
	bool Delete(const char*url, PyObject* headers);
