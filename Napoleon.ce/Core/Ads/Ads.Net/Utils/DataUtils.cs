...
namespace GRSoft.Ads.Utils
{
   ...
   class DataUtils
   {
      ...
      public static readonly string USERID_IS_NULL_STR = "userid is null";
      ...
      {
         return String.Format("{0} >= ToDate('{1}') and {0} < ToDate('{2}')",
               field,
      ...
      public static void FillGridFromDS(DataGridView dataGrid, DataGridViewColumn sortColumn, 
         IDataSet dataSet)
      {
   ...
   public class FindDataGridObject : FindObject
   {
      ...
      protected DataGridViewRow Next()
      {
      ...
      public virtual void Select(IEnumerator iter)
      {
         if (iter != null)
         {
