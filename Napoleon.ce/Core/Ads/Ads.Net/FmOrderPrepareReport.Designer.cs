...
{
   partial class FmOrderPrepareReport
   {
      /// <summary>
      ...
      {
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FmOrderPrepareReport));
         ...
         this.cbDateFact = new System.Windows.Forms.CheckBox();
         this.cbDatePlan = new System.Windows.Forms.CheckBox();
         ...
         // gbMainData
         // 
         this.gbMainData.Controls.Add(this.cbReport);
         this.gbMainData.Controls.Add(this.cbAddress);
         this.gbMainData.Controls.Add(this.cbClient);
         this.gbMainData.Controls.Add(this.cbText);
         this.gbMainData.Controls.Add(this.cbDateFact);
         this.gbMainData.Controls.Add(this.cbDatePlan);
         ...
         this.cbReport.Location = new System.Drawing.Point(193, 21);
         this.cbReport.Name = "cbReport";
         this.cbReport.Size = new System.Drawing.Size(55, 17);
         this.cbReport.TabIndex = 8;
         this.cbReport.Tag = "Remark";
         this.cbReport.Text = "Отчет";
         this.cbReport.UseVisualStyleBackColor = true;
         // 
         // cbAddress
         // 
         this.cbAddress.AutoSize = true;
         this.cbAddress.Location = new System.Drawing.Point(99, 70);
         ...
         this.cbClient.Location = new System.Drawing.Point(99, 53);
         this.cbClient.Name = "cbClient";
         this.cbClient.Size = new System.Drawing.Size(62, 17);
         this.cbClient.TabIndex = 6;
         this.cbClient.Tag = "ClientName";
         this.cbClient.Text = "Клиент";
         this.cbClient.UseVisualStyleBackColor = true;
         // 
         // cbText
         // 
         this.cbText.AutoSize = true;
         this.cbText.Location = new System.Drawing.Point(99, 36);
         this.cbText.Name = "cbText";
         this.cbText.Size = new System.Drawing.Size(89, 17);
         this.cbText.TabIndex = 5;
         this.cbText.Tag = "Text";
         this.cbText.Text = "Содержание";
         this.cbText.UseVisualStyleBackColor = true;
         // 
         // cbDateFact
         // 
         this.cbDateFact.AutoSize = true;
         this.cbDateFact.Location = new System.Drawing.Point(99, 19);
         this.cbDateFact.Name = "cbDateFact";
         this.cbDateFact.Size = new System.Drawing.Size(87, 17);
         this.cbDateFact.TabIndex = 4;
         this.cbDateFact.Tag = "FactTimeStr";
         this.cbDateFact.Text = "Время факт";
         this.cbDateFact.UseVisualStyleBackColor = true;
         // 
         // cbDatePlan
         // 
         this.cbDatePlan.AutoSize = true;
         this.cbDatePlan.Location = new System.Drawing.Point(12, 72);
         this.cbDatePlan.Name = "cbDatePlan";
         this.cbDatePlan.Size = new System.Drawing.Size(86, 17);
         this.cbDatePlan.TabIndex = 3;
         this.cbDatePlan.Tag = "WorkTimeStr";
         this.cbDatePlan.Text = "Время план";
         this.cbDatePlan.UseVisualStyleBackColor = true;
         // 
         // cbDate
         // 
         ...
         this.Name = "FmOrderPrepareReport";
      ...
      private System.Windows.Forms.CheckBox cbDatePlan;
      ...
      private System.Windows.Forms.CheckBox cbDateFact;
