namespace GRSoft.Ads
{
   partial class FmCertificate
   {
      ...
      {
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FmCertificate));
         ...
         this.dgvSertificatesName = new System.Windows.Forms.DataGridViewTextBoxColumn();
         this.dgvSertificatesAssigned = new System.Windows.Forms.DataGridViewTextBoxColumn();
         ...
         // 
         this.splitContainer1.Panel2.Controls.Add(this.dgvCertificates);
         ...
         this.dgvCertificates.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
            this.dgvSertificatesName,
            this.dgvSertificatesAssigned});
         ...
         this.dgvCertificates.Size = new System.Drawing.Size(282, 347);
         this.dgvCertificates.TabIndex = 0;
         // 
         // dgvSertificatesName
         // 
         this.dgvSertificatesName.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill;
         this.dgvSertificatesName.DataPropertyName = "Number";
         this.dgvSertificatesName.HeaderText = "Серия/Номер";
         this.dgvSertificatesName.Name = "dgvSertificatesName";
         // 
         // dgvSertificatesAssigned
         // 
         this.dgvSertificatesAssigned.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill;
         this.dgvSertificatesAssigned.DataPropertyName = "AssignedStr";
         this.dgvSertificatesAssigned.HeaderText = "Дата";
         this.dgvSertificatesAssigned.Name = "dgvSertificatesAssigned";
         // 
         // statusStrip1
         // 
         ...
         this.Name = "FmCertificate";
         this.Text = "Свидетельства";
      ...
      private System.Windows.Forms.DataGridViewTextBoxColumn dgvSertificatesName;
      private System.Windows.Forms.DataGridViewTextBoxColumn dgvSertificatesAssigned;
