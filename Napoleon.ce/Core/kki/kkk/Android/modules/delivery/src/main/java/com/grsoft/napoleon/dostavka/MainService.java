...
//	private NotificationManager  notificationManager;
	...
	private int NOTIFICATION = com.grsoft.napoleon.R.string.app_name;
	...
	private void showNotify(String caption) {
		...
		Notification.Builder builder = new Notification.Builder(this)
				...
				.setContentText(getString(com.grsoft.napoleon.R.string.select_for_open))
				.setSmallIcon(com.grsoft.napoleon.R.drawable.napoleon)
				.setAutoCancel(false)
