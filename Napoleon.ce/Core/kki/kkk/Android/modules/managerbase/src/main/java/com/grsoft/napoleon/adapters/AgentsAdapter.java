...
public class AgentsAdapter extends BaseAdapter {
	...
	public AgentsAdapter(List<RowItem> agents, ReportData data, Context context) {
		this.context = context;
		refresh(agents, data);
	}
	
	public void refresh(List<RowItem> agents, ReportData data) {
		this.agents = agents;
		this.data = data;		
	...
	public View getView(int pos, View view, ViewGroup arg2) {
		RowItem info = (RowItem) getItem(pos);
