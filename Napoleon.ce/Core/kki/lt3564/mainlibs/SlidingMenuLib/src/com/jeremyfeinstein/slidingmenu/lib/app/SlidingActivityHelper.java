...
public class SlidingActivityHelper {
	...
	public static final String EXTRSA_RESOURCE_ID = "resource_id";
	...
	public void onCreate(Bundle savedInstanceState) {
		this.mSlidingMenu = ((SlidingMenu)LayoutInflater.from(this.mActivity).inflate(
				this.mActivity.getIntent().getIntExtra(EXTRSA_RESOURCE_ID, 0), null));
	}
