...
public class AmbilWarnaDialog {
     ...
     *            current color
     * @param listener
     *            an OnAmbilWarnaListener, allowing you to get back error or OK
     */
     ...
     *            current color
     * @param supportsAlpha
     *            whether alpha/transparency controls are enabled
     * @param listener
     *            an OnAmbilWarnaListener, allowing you to get back error or OK
     */
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    if ((event.getAction() == MotionEvent.ACTION_MOVE)
                        ...
                        if (y > viewAlphaCheckered.getMeasuredHeight()) {
                            y = viewAlphaCheckered.getMeasuredHeight() - 0.001f; // to avoid jumping the cursor from
                                                                                 // bottom to top.
                        }
    ...
    protected void moveAlphaCursor() {
        ...
        final RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) this.viewAlphaCursor
                .getLayoutParams();
        layoutParams.leftMargin = (int) (this.viewAlphaCheckered.getLeft()
                - Math.floor(this.viewAlphaCursor.getMeasuredWidth() / 2) - this.viewContainer.getPaddingLeft());
        layoutParams.topMargin = (int) ((this.viewAlphaCheckered.getTop() + y)
                - Math.floor(this.viewAlphaCursor.getMeasuredHeight() / 2) - this.viewContainer.getPaddingTop());
