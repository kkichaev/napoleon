...
public class SetMultiPerformerDialog extends DialogFragment//
        implements DialogInterface.OnClickListener, OnEditorActionListener {

    private static final String CLASS_PATH = SetMultiPerformerDialog.class.getName();
    ...
    public static final int REQUEST_CODE = R.id.multi_performer_dialog_request_code;
    ...
    public static SetMultiPerformerDialog newInstance(Fragment fragment, String performer) {
        final Bundle b = new Bundle();
        if (!TextUtils.isEmpty(performer)) {
            b.putString(EXTRA_PERFORMER, performer);
        }

        final SetMultiPerformerDialog d = new SetMultiPerformerDialog();
    ...
    public static SetMultiPerformerDialog newInstanceCustomTitle(Fragment fragment, int titleId) {
        final Bundle b = new Bundle();
    ...
    public Dialog onCreateDialog(Bundle b) {
        ...
        mAdapter = new MultiEmployeeAdapter(getActivity());
    ...
    public void onSaveInstanceState(Bundle b) {
        ...
        final ArrayList<String> performers = mAdapter.getCheckedPerformers();
            b.putStringArrayList(EXTRA_PERFORMER, performers);
    }

    @Override
    public void onClick(DialogInterface dialog, int which) {
        if (getTargetFragment() != null && which == Dialog.BUTTON_POSITIVE) {
            ArrayList<String> performers = mAdapter.getCheckedPerformers();

            if (getTargetFragment() instanceof BaseFragment) {
                ((BaseFragment<?, ?>) getTargetFragment()).onFragmentResult(performers, REQUEST_CODE);
            }
        }
