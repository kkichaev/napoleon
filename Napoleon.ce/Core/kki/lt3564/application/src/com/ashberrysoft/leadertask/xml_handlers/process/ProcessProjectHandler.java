...
public class ProcessProjectHandler extends BaseProcessListLionEntityHandler<Project> {

    public ProcessProjectHandler(XMLReader reader, DefaultHandler defaultHandler) {
        super(reader, defaultHandler);
    }

    @Override
    protected BaseXmlSaxHandlerProcessAll<List<Project>> getBaseProcessListLionEntityHandler(XMLReader reader,
