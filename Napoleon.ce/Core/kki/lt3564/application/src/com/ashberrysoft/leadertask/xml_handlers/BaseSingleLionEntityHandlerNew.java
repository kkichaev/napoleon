...
public abstract class BaseSingleLionEntityHandlerNew<T extends BaseLionEntityInterface> extends BaseXmlSaxHandlerProcessAll<T> {

    private HashMap<String, Boolean> mEntity;
    private StringBuilder mStringBuilder;

    public BaseSingleLionEntityHandlerNew(XMLReader reader, DefaultHandler defaultHandler) {
