...
public class Crypto {
	...
	public static String encrypt(String cleartext)throws Exception {
		return encrypt(KeeperApp.masterPassword, cleartext);
	}
	...
	public static String decrypt(String cleartext)throws Exception {
		return decrypt(KeeperApp.masterPassword, cleartext);
	}
	...
	private static byte[] getRawKey(byte[] password) throws Exception {
		...
		SecretKey key = new SecretKeySpec(digest.digest(password), ALGORITM);
        return key.getEncoded();
	}
	
	private static byte[] encrypt(byte[] raw, byte[] clear) throws Exception {
	    SecretKeySpec skeySpec = new SecretKeySpec(raw, ALGORITM);
