...
public class Uri extends BaseActivity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null)
			group_id = getIntent().getExtras().getInt(GROUP_ID_STR, -1);
		else
			group_id = savedInstanceState.getInt(GROUP_ID_STR, -1);
		...
		Cursor cursor = db.query("[group]", new String[]{"name"}, "_id=?", 
				new String[]{Integer.toString(group_id)}, null, null, null);
	...
	public static void open(Context context, int group_id){
	...
	protected void onSaveInstanceState(Bundle outState) {
		outState.putInt(GROUP_ID_STR, group_id);
	...
	protected void onResume() {
		...
		Cursor cursor = db.query("uri", 
				...
				new String[]{Integer.toString(group_id)}, null, null, "uri, alias");
	...
	protected void onPrepareDialog(int id, Dialog dialog, final Bundle args) {
		...
		case DLG_EDIT_URI:
			...
			break;
		case DLG_MOVE_URI:
			Cursor c = KeeperApp.dbManager.getReadableDatabase().query("[group]",
					new String[]{"name"}, "_id=?", 
					new String[]{Integer.toString(group_id)}, null, null, null);
...
class InsertUri extends GroupAsyncOper{
	...
	protected Boolean doInBackground(Object... params) {
		try{
			...
			values.put("group_id", (Integer)params[2]);
...
class GroupSimpleSelectAdapter extends CursorAdapter{
	public GroupSimpleSelectAdapter(Context context) {
		super(context, 
				KeeperApp.dbManager.getWritableDatabase().query(
