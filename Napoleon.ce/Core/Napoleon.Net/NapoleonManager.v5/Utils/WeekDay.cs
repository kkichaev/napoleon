...
namespace GRSoft.NapoleonManager.Utils
{
   ...
   public class WeekDay
   {
      ...
      {
         return Char.IsNumber(name[0]) ? name.Substring(1) : name;
      }
      ...
      public static int WeekIndex(string name)
      {
         return Char.IsNumber(name[0]) ? int.Parse(name.Substring(0, 1)) : 0;
      }
      ...
      public WeekDay(int number)
         : this(fullnames[number == 0? fullnames.Length - 1 : number-1])
      {
      }
      ...
      public DayOfWeek DayOfWeek { get { return index == 7 ? DayOfWeek.Sunday : (DayOfWeek)index + 1; } }
      ...
      public override bool Equals(object obj)
      {
         ...
         if(wd == null)
         {
            ...
            if( s != null)
               return FullName.CompareTo(StripPrefix(s)) == 0;
