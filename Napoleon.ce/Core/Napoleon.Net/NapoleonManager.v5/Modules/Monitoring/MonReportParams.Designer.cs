namespace GRSoft.NapoleonManager
{
   partial class MonReportParams
   {
      ...
      {
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MonReportParams));
         this.cancel = new System.Windows.Forms.Button();
         this.ok = new System.Windows.Forms.Button();
         this.cbOur = new System.Windows.Forms.CheckBox();
         this.cbConcurents = new System.Windows.Forms.CheckBox();
         ...
         this.cancel.Location = new System.Drawing.Point(210, 169);
         ...
         this.ok.Location = new System.Drawing.Point(129, 169);
         this.ok.Name = "ok";
         ...
         // cbOur
         // 
         this.cbOur.AutoSize = true;
         this.cbOur.Checked = true;
         this.cbOur.CheckState = System.Windows.Forms.CheckState.Checked;
         this.cbOur.Location = new System.Drawing.Point(118, 118);
         this.cbOur.Name = "cbOur";
         this.cbOur.Size = new System.Drawing.Size(110, 17);
         this.cbOur.TabIndex = 13;
         this.cbOur.Text = "Наша продукция";
         this.cbOur.UseVisualStyleBackColor = true;
         // 
         // cbConcurents
         // 
         this.cbConcurents.AutoSize = true;
         this.cbConcurents.Checked = true;
         this.cbConcurents.CheckState = System.Windows.Forms.CheckState.Checked;
         this.cbConcurents.Location = new System.Drawing.Point(118, 142);
         this.cbConcurents.Name = "cbConcurents";
         this.cbConcurents.Size = new System.Drawing.Size(87, 17);
         this.cbConcurents.TabIndex = 14;
         this.cbConcurents.Text = "Конкуренты";
         this.cbConcurents.UseVisualStyleBackColor = true;
         // 
         // rbAgents
         // 
         ...
         this.Controls.Add(this.cbConcurents);
         this.Controls.Add(this.cbOur);
         this.Controls.Add(this.cancel);
         this.Controls.Add(this.ok);
         this.Icon = ((System.Drawing.Icon)(resources.GetObject("$this.Icon")));
         this.Name = "MonReportParams";
      ...
      public System.Windows.Forms.CheckBox cbOur;
      public System.Windows.Forms.CheckBox cbConcurents;
