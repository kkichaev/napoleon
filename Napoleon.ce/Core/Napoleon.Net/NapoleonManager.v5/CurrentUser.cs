...
namespace GRSoft.NapoleonManager
{
   ...
   static class CurrentUser
   {
      ...
      public static void SetCurrentUser(bool throwException)
      {
         if (dsManager != null)
         {
            ...
            else
            {
               ...
               CreateCurrentUser(c, throwException);
            }
            dsManager = null;
         }
         else
      ...
      private static void CreateCurrentUser(Config config, bool throwException)
      {
         foreach (Agent a in DataModule.Get("Agents").Data)
         {
            if (a.id == config.userid)
            {
               Division d = null;
