namespace GRSoft.NapoleonManager
{
   partial class FmConfig
   {
      ...
      private void InitializeComponent()
      {
         ...
         // tpUser
         // 
         this.tpUser.Controls.Add(this.btnConnect);
         this.tpUser.Controls.Add(this.label2);
         this.tpUser.Controls.Add(this.label1);
         this.tpUser.Controls.Add(this.tbCode);
         ...
         // btnConnect
         // 
         this.btnConnect.Location = new System.Drawing.Point(137, 174);
         ...
         this.label2.Text = "Для подключения устройства к системе введите код, отправленный вашим руководителе" +
    "м и нажмите кнопку \"Подключить\".";
         // 
         // label1
         // 
         ...
         this.label1.Text = "Код подключения";
         // 
         // tbCode
         // 
         ...
         this.tbCode.Location = new System.Drawing.Point(121, 50);
         this.tbCode.Name = "tbCode";
         this.tbCode.Size = new System.Drawing.Size(131, 26);
