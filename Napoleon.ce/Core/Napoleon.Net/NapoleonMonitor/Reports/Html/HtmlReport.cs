...
namespace GRSoft.NapoleonManager
{
   internal class HtmlReport
   {
      ...
      protected class AgentSummaryInfo
      {
      ...
      protected string makeHtmlRowFromTreeGridNode(TreeGridNode node, TreeGridView grid, 
      ...
      public class RouteDetailData : List<RouteDetailItem>
      {
         ...
         public virtual void BuildRow(StringBuilder sb, Total ret, RouteDetailItem item, OrderDetailRepresentation data)
         {
            ...
            sb.AppendFormat("<td><FONT SIZE=\"2\">{0}</td>", data.Doctype.ToString());
      ...
      public class RouteDetailReport : Dictionary<DateTime, RouteDetailData>
      {
         ...
         public RouteDetailReport(DataGridView dgvDetail, AgentItem agent)
         {
            this.grid = dgvDetail;
      ...
      public string makeDetailsFileInfo(DataGridView dgvDetail, TimeInterval interval, AgentItem agent)
      {
      ...
      protected virtual RouteDetailReport CreateRouteDetailReport(DataGridView dgvDetail, AgentItem agent)
      {
