...
namespace GRSoft.NapoleonManager.Reports
{
   ...
   {
      IReport MakeRouteReport(DataSet<int, OrgFolder> dsOrgFolder, List<Division.DivisionAgent> agents,
         Type reportType);
   }
   ...
   class ExcelReportFactory : IReportFactory
   {
      ...
      public IReport MakeRouteReport(DataSet<int, OrgFolder> dsOrgFolder, List<Division.DivisionAgent> agents,
         Type reportType)
      {
