...
namespace GRSoft.Network
{
   ...
   public class Debug
   {
      public static StringBuilder debugInfo = new StringBuilder();
   }
#endif
   ...
   public class PacketObject : List<ObjectList>
   {
...
#if TRACE_GRPACKET
         File.AppendAllText("packet.txt", Debug.debugInfo.ToString() + "\n");
#endif
      }
      ...
      public bool Receive(Stream netStream, IProgress progress)
      {
         ...
         byte[] utf8Bytes = utf8.GetBytes(str.ToString());
         byte[] win1251Bytes = Encoding.Convert(utf8, win1251, utf8Bytes);

         File.AppendAllText("out.txt", win1251.GetString(win1251Bytes) + "\n", win1251);
         stream.MoveToFirst();
#endif
