...
namespace GRSoft.NapoleonManager
{
   public class Config
   {
      private static readonly string OBJECT_NAME = "Dispatcher";
      static readonly string FILE_NAME = OBJECT_NAME + ".cfg";
      public static string FOLDER = "\\GRSoft\\" + OBJECT_NAME  + "\\";
      ...
      public static readonly string PASSWORD = new string(new char[] {'m','a','n','a','g','e','r','1'});
      public static readonly string ADM_PASSWORD = new string(new char[] { 'a', 'd', 'm', 'i', 'n' });
      ...
      public string mapSource = string.Empty;
      ...
      public short hourStart = 7;
      public short hourEnd = 20;

      public bool addrView = true;
      public bool clitnView = true;
      public bool textView = true;

      public string city = string.Empty;
      public List<string> cities = new List<string>();

      public long wtStart = new TimeSpan(7, 30, 0).Ticks;
      public long wtFinish = new TimeSpan(16, 30, 0).Ticks;
