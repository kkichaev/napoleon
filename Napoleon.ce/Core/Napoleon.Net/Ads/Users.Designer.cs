namespace GRSoft.NapoleonManager
{
   partial class Users
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.btnAdd.Image = global::GRSoft.NapoleonManager.Properties.Resources.expand;
         ...
         this.dgvUsersLicence.Visible = false;
         // 
         // Column1
         // 
         this.Column1.DataPropertyName = "Hidden";
         this.Column1.HeaderText = "Скрыть";
