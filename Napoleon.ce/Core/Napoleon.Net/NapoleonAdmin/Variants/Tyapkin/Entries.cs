...
namespace GRSoft.NapoleonAdmin
{
   ...
   class UserDataItemEx : UserDataItem
   {
      ...
      bool GetGroupReportFilter(string name, bool defaulValue)
      {
      ...
      public bool GroupReportFilter
      {
         get { return GetGroupReportFilter("group_report_filter", false); }
         set { ChangeConfigValue("group_report_filter", value); }
      }
   }
}