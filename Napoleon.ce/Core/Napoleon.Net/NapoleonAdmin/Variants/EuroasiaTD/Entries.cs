...
namespace GRSoft.NapoleonAdmin
{
   ...
   class UserDataItemEx : UserDataItem
   {
      ...
      void ChangeRight(string name, bool value)
      {
         ...
         manager.ChangeRight(new RightToken("ManagerFolder", "ManagerFolder"), value ? RightActions.Write: RightActions.None);
         manager.ChangeRight(new RightToken("Folder", "Folder"), value ? RightActions.Write: RightActions.None);
