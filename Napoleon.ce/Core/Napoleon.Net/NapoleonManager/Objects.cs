...
namespace GRSoft.NapoleonManager
{
   ...
   public class ObjType
   {
      public enum TObjType
      {
         ...
         Exchange, Target, Equipment, AgentMemo, PurchaseDoc, WhRequest, NoPhoto
      }
...
//#endif
   ...
   public partial class ManagerFolder : DataObject, IComparable<ManagerFolder>
   {
      ...
      public static readonly string COMMON_FOLDERS_NAME = "CommonManagerFolders";
   ...
   public partial class Matrix : DataObject, ICloneable
   {
      ...
      public object Clone()
      {
         Matrix res = (Matrix)MemberwiseClone();
         return res;
      }
   }
