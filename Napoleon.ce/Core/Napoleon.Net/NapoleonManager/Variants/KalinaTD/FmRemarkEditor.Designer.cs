namespace GRSoft.NapoleonManager
{
   partial class FmRemarkEditor
   {
      ...
      {
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FmRemarkEditor));
         ...
         this.grid.Size = new System.Drawing.Size(754, 500);
         ...
         this.Name = "FmRemarkEditor";
         this.Text = "Комментарий в заявке";
         this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FmRemarkEditor_FormClosing);
         this.Load += new System.EventHandler(this.FmRemarkEditor_Load);
