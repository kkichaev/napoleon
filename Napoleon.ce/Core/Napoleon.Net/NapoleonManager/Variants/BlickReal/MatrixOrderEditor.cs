...
namespace GRSoft.NapoleonManager
{
   ...
   {
      public static readonly int MAX_ORDERED_MATRIX = 3;
      ...
      private void tsbAdd_Click(object sender, EventArgs e)
      {
         ...
         if (m == null || lvOrderedMatrix.Items.Count >= MAX_ORDERED_MATRIX)
            return;
         ...
         Invoke(new EmptyParamHandler(() =>
            {
               ...
               tsbAdd.Enabled = tvAgentMatrix.SelectedNode != null && lvOrderedMatrix.Items.Count < MAX_ORDERED_MATRIX;
