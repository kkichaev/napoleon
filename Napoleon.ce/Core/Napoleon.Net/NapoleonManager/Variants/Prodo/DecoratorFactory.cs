...
namespace GRSoft.NapoleonManager
{
   ...
   class DivisionDecorator : EmptyDecorator
   {
      public DivisionDecorator(Divisions form)
      {
         ...
         ToolStripMenuItem tsMargin = new ToolStripMenuItem("Наценка");
         tsMargin.Click += new EventHandler((o, e) => { Form f = new EditOrgMargin(); f.Show(); });
         form.tb.Items.Add(tsMargin);

         ToolStripMenuItem tsPlan = new ToolStripMenuItem("План");
         tsPlan.Click += new EventHandler((o, e) => { Form f = new EditOrgPlan(); f.Show(); });
         form.tb.Items.Add(tsPlan);
      }
   }
