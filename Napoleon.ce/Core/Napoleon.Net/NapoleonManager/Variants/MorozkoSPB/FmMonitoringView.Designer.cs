...
{
   partial class FmMonitoringView
   {
      /// <summary> 
      ...
      private void InitializeComponent()
      {
         ...
         this.Column4.HeaderText = "Цена без карты";
         this.Column4.Name = "Column4";
         this.Column4.ReadOnly = true;
         // 
         // Column5
         // 
         this.Column5.DataPropertyName = "Cost1";
         this.Column5.HeaderText = "Цена по карте";
         this.Column5.Name = "Column5";
         this.Column5.ReadOnly = true;
         // 
         // Column3
         // 
         this.Column3.DataPropertyName = "Cost2";
         this.Column3.HeaderText = "Промо цена";
