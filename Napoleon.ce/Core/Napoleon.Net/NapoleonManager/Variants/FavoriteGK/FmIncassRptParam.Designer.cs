...
{
   partial class FmIncassRptParam
   {
      /// <summary>
      ...
      {
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FmIncassRptParam));
         ...
         this.Name = "FmIncassRptParam";
         this.Text = "Отчёт по инкассации";
