...
namespace GRSoft.NapoleonManager
{
   class MainFormEx : MainForm
   {
      ...
      public MainFormEx()
      {
         ...
         ToolStripButton btnReturn = new System.Windows.Forms.ToolStripButton();
         btnReturn.DisplayStyle = System.Windows.Forms.ToolStripItemDisplayStyle.Image;
         btnReturn.Image = Properties.Resources.return_doc;
         btnReturn.ImageTransparentColor = System.Drawing.Color.Magenta;
         btnReturn.Name = "btnReturn";
         btnReturn.Size = new System.Drawing.Size(23, 22);
         btnReturn.Text = "Отчет по возвратам";
         btnReturn.Click += new System.EventHandler((s, e) => { new FmReturnReport().Show(); });

         tsbConfig.Items.Add(btnPhoto);
         tsbConfig.Items.Add(btnReport);
         //tsbConfig.Items.Add(btnReturn);
