...
namespace GRSoft.NapoleonManager
{
  [System.Security.Permissions.PermissionSet(System.Security.Permissions.SecurityAction.Demand, Name = "FullTrust")]
   ...
   class FmDetailEx : FmDetail
   {
      ...
      SimpleDataSet<Order> dsLoadedOrders = new SimpleDataSet<Order>("LoadedOrders", true, true);
      ...
      protected override void BeforeRefreshData(List<IDataSet> updSets, string agentID, DateTime dateBegin, DateTime dateEnd)
      {
         ...
         dsLoadedOrders.Filter = String.Format(COMMON_FILTER_STR, "created", dateBegin, dateEnd, agentID); ;
         updSets.Add(dsBonus);
         updSets.Add(dsDistrib);
         updSets.Add(dsDistribMatrix);
         updSets.Add(dsLoadedOrders);
      }

      protected override void AfterRefreshData()
      {
         foreach (Order o in dsLoadedOrders.Data)
         {
            dsOrder.Add(dsOrder.Count, o);
         }
         dsLoadedOrders.Clear();
      }
