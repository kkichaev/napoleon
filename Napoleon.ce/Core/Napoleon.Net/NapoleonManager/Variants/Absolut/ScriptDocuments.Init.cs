...
#if (Ardis || Metelica || VladHleb || MichelK || Athina || RPK || Ishim || TD12Months || MariMedSnab || Bella || ClearLine || LukasN || Modus || Birsnek || Demetra || PolyGrand || MyasoDel || Sapfire || Stantor || WallStreet || Beybars || Servolux || Alianta || Frolov || Chuvakova || BeautyProfy || ROST || Vetli)
#else
