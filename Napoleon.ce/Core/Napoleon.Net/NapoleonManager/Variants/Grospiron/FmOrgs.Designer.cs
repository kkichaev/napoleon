namespace GRSoft.NapoleonManager
{
   partial class FmOrgs
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.clmnBrand = new System.Windows.Forms.DataGridViewTextBoxColumn();
         ...
         this.toolStripButton1.Image = global::GRSoft.NapoleonManager.Properties.Resources.abiword_3;
         this.toolStripButton1.ImageTransparentColor = System.Drawing.Color.Magenta;
         this.toolStripButton1.Name = "toolStripButton1";
         this.toolStripButton1.Size = new System.Drawing.Size(36, 36);
         this.toolStripButton1.Text = "Загркзить из Excel";
         ...
         this.cbAgents.SelectedIndexChanged += new System.EventHandler(this.cbDivision_SelectedIndexChanged);
         // 
         // grid
         // 
         ...
         // clmnBrand
         // 
         this.clmnBrand.DataPropertyName = "Brand";
         this.clmnBrand.HeaderText = "Сеть";
         this.clmnBrand.Name = "clmnBrand";
         // 
         // Column4
         // 
         this.Column4.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill;
         this.Column4.DataPropertyName = "FormatTT";
         this.Column4.HeaderText = "Формат";
         this.Column4.Name = "Column4";
         // 
         // clmnCity
         // 
         this.clmnCity.DataPropertyName = "City";
         this.clmnCity.HeaderText = "Город";
         this.clmnCity.Name = "clmnCity";
         // 
         // Column3
         // 
         this.Column3.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill;
         this.Column3.DataPropertyName = "Address2";
      ...
      private System.Windows.Forms.ToolStripButton toolStripButton1;
        ...
        private System.Windows.Forms.DataGridViewTextBoxColumn clmnBrand;
