...
{
   partial class RejectActOverview
   {
      /// <summary> 
      ...
      private void InitializeComponent()
      {
         ...
         this.clmnParty = new System.Windows.Forms.DataGridViewTextBoxColumn();
         ...
         // clmnParty
         // 
         this.clmnParty.DataPropertyName = "Party";
         this.clmnParty.HeaderText = "Партия";
         this.clmnParty.Name = "clmnParty";
         this.clmnParty.Width = 140;
         // 
         // dgvOrderItemsQty
         // 
      ...
      private System.Windows.Forms.DataGridViewTextBoxColumn clmnParty;
