...
namespace GRSoft.NapoleonManager
{
   class HtmlReportEx : HtmlReport
   {
      ...
      protected override HtmlReport.RouteDetailReport CreateRouteDetailReport(System.Windows.Forms.DataGridView dgvDetail, AgentItem agent)
      {
   ...
   {
      public RouteDetailReportEx(DataGridView dgvDetail, AgentItem agent)
