namespace GRSoft.NapoleonManager
{
   partial class FmAgentPlan
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.dtpDate.Value = new System.DateTime(2016, 3, 1, 11, 10, 0, 0);
         // 
         // cbAgent
         // 
         ...
         this.tgvPrice.Size = new System.Drawing.Size(831, 560);
         ...
         // Column2
         // 
         this.Column2.HeaderText = "План руб.";
         ...
         // Column3
         // 
         this.Column3.HeaderText = "План бут.";
         ...
         // Column4
         // 
         this.Column4.HeaderText = "Факт руб.";
         ...
         // Column5
         // 
         this.Column5.HeaderText = "Факт бут.";
         ...
         // Column6
         // 
         this.Column6.HeaderText = "Аппр. % руб.";
         ...
         // Column7
         // 
         this.Column7.HeaderText = "Аппр. % бут.";
