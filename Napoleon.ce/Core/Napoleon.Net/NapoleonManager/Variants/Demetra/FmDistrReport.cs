...
namespace GRSoft.NapoleonManager
{
   public partial class FmDistrReport : Form
   {
      ...
      DateTime Begin { set { dpv.Start = value; dtpDailyReport.Value = value; } }
      DateTime Finish { set { dpv.Finish = value; } }
      ...
      class Param : GRSoft.Network.DataObject
      {
         ...
         public DateTime dailyReport = DateTime.MinValue;

         public int periodicReports = 0;
         public string userid = "";
      }

      private void btnReport_Click(object sender, EventArgs e)
      {
         const string MODULE_NAME = "distrib_groups";
         Param param = new Param();
         param.start = dpv.Start.Date;
         param.finish = dpv.Finish.Date;

         param.periodicReports = cbPeriodReports.Checked ? 1 : 0;
         param.userid = userid;
         param.dailyReport = dtpDailyReport.Value;
      ...
      internal static void Do(DateTime begin, DateTime end, string userid)
      {
         FmDistrReport form = new FmDistrReport();
         form.Begin = begin;
         form.Finish = end;
         form.userid = userid;
         form.Show();
      ...
      private void cbPeriodReports_CheckedChanged(object sender, EventArgs e)
      {
         dpv.Enabled = cbPeriodReports.Checked;
      }
   }
}
