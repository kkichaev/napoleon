...
namespace GRSoft.NapoleonManager
{
   class FormEntries
   {
      ...
      internal static System.Type GetFormType(System.Type baseType)
      {
         ...
         if (baseType == (typeof(FmViewPhoto)))
            return typeof(FmViewPhotoEx);

         if (baseType == (typeof(ClientCard)))
            return typeof(ClientCardEx);

         if (baseType == (typeof(RemnantsOverview)))
            return typeof(RemnantsOverviewEx);
