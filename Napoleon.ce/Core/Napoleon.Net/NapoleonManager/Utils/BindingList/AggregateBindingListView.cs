    ...
    public class AggregateBindingListView<T> : Component, IBindingListView, IList, IRaiseItemChangedEvents, ICancelAddNew, ITypedList
    {
        ...
        public IList SourceLists
        {
            ...
            set
            {
                if (value == null)
                {
                    throw new ArgumentNullException("SourceLists", "SourceListsNull");
                }
                ...
                foreach (object obj in value)
                {
                    ...
                    foreach (object item in list)
                    {
                        if (!(item is T))
                        {
                            throw new InvalidSourceListException(string.Format("InvalidListItemType: {0}", typeof(T).FullName));
                        }
                    }
                }
        ...
        public IList NewItemsList
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("SourceListNotFound");
                }
                _newItemsList = value;
            }
        }
        ...
        */
        ...
        public int Find(string propertyName, object key)
        {
            ...
            {
                throw new ArgumentException(string.Format("PropertyNotFound: {0}", propertyName, typeof(T).FullName), "propertyName");
            }
        }
        ...
        int IList.Add(object value)
        {
            ...
            throw new NotSupportedException("CannotAddItem");
        }
        ...
        void IList.Clear()
        {
            throw new NotSupportedException("CannotClearView");
        }
        ...
        {
            throw new NotSupportedException("CannotInsertItem");
        }
