...
namespace GRSoft.NapoleonManager.Reports.Excel
{
   class ExcelOrderReport : Excel, IReportImplementation
   {
...
#elif MyasoDel || Sapfire || PoultryNSib || Antonov || MeatAlliance || TDSiberia
      ...
      const int COL_ORGS_INDEX = 3;
      static readonly string ITEMS_HEAD = "Номенклатура";
      static readonly string ITEM_QTY = "л.";
      static readonly string PACK_QTY = "кеги";
#else
      const int COL_ORGS_INDEX = 3;
      static readonly string ITEMS_HEAD = "Номенклатура";
      public static string ITEM_QTY = "шт.";
      public static string PACK_QTY = "уп.";
#endif
...
#endif
                  for (valueIndex = 0; valueIndex < finalValues.Size; ++valueIndex)
