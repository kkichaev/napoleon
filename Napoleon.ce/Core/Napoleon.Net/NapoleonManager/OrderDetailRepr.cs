...
namespace GRSoft.NapoleonManager
{
   ...
   public class OrgRouteOrder : IComparable
   {
      ...
      OrgFolderItem routeItem;

      public OrgRouteOrder(OrderDetailRepresentation obj, DateTime date, int pos, List<OrderDetailRepresentation> owner, OrgFolderItem routeItem)
      {
      ...
      public OrgFolderItem RouteItem { get { return routeItem; } }
