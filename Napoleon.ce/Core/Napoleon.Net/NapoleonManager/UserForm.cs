...
namespace GRSoft.NapoleonManager
{
   public partial class UserForm : UserControl
   {
      ...
      SimpleDataSet<MatrixOrder> dsOrderMatrix = new SimpleDataSet<MatrixOrder>(MatrixOrder.OBJECT_NAME, false);
      ...
      protected void GetDataForCurAgent(string AgentID)
      {
         ...
         dsOrderMatrix.Filter = "\"userid\"='" + agent.id + "'";
         updSets.Add(dsOrderMatrix);
      ...
      private void DataCurAgentLoaded(object sender, EventArgs e)
      {
         ...
         lvc.Clear();
         foreach (MatrixOrder mo in dsOrderMatrix.Data)
         {
            mo.items.Sort();
      ...
      void UncheckNodes(TreeNodeCollection nodes, DataSet<string, HiddenFolders> hidden)
      {
         foreach(TreeNode tn in nodes)
         {
            ...
            tn.Checked = !(hidden.ContainsKey(mf.id));
            if (tn.Nodes.Count > 0)
