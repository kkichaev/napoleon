...
{
   virtual bool CreateDocument(const ROWID &orgID) = 0;

   virtual bool Init(const ROWID &orgID) = 0;

   virtual IDocument* Copy() = 0;
   ...
   //virtual const wchar_t* SendText(int count) const = 0;
