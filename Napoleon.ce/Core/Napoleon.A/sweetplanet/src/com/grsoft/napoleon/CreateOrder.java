...
public class CreateOrder extends BaseActivity
{
	...
	private CheckBox cbDoverMoney;
	private CheckBox cbDoverVozvrat;
	private CheckBox cbReestrSert;
	private EditText edDoverMoney;
...
//	DateHandler dateHandler;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cbDoverMoney = (CheckBox) findViewById(R.id.cbDoverMoney);
		cbDoverVozvrat = (CheckBox) findViewById(R.id.cbDoverVozvrat);
		cbReestrSert = (CheckBox) findViewById(R.id.cbReestrSert);
		edDoverMoney = (EditText) findViewById(R.id.edDoverMoney);
...
//		dateHandler = new DateHandler((TextView)findViewById(R.id.tvDate), o.date, DIALOG_DATE_PICKER_ID);
		...
		cbDoverMoney.setChecked(o.dovmoney != 0);
		cbDoverVozvrat.setChecked(o.dovozv != 0);
		cbReestrSert.setChecked(o.reesrt != 0);
		edDoverMoney.setText(Util.IntToScaleStr(o.money, Consts.SUM_SCALE));
	}
...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
			...
			o.dovmoney = cbDoverMoney.isChecked() ? 1 : 0;
			o.dovozv = cbDoverVozvrat.isChecked() ? 1 : 0;
			o.reesrt = cbReestrSert.isChecked() ? 1 : 0;
			o.money = Util.StrToScale(edDoverMoney.getText().toString().trim(), Consts.SUM_SCALE);
