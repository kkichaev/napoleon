...
import com.grsoft.dataobjects.DeliveryBase;
import com.grsoft.napoleon.R;
import com.grsoft.util.Consts;
import com.grsoft.util.Util;

public class DebtDocBase extends DebtDoc {
	
	public static void initialize() {
		if( instance != null )
			throw new RuntimeException("DebtDoc уже создан!");
		instance = new DebtDocBase();
	}
	...
	public void setView(Adapter adapter, View view, Document<?> doc) {
		...
		Date payDate = ((DeliveryBase)d).getPayDate();
		Date checkDate = new Date();
		String str;
		int color = (d.sumD > 0 && payDate.compareTo(checkDate) < 0) ? Color.RED : Color.BLACK;
		TextView tv;
		...
		str += "\n";
		str += Util.simpleDateFormat.format(payDate);
		tv.setText(str);
