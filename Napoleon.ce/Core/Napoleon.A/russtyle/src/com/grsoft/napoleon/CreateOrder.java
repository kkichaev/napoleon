...
public class CreateOrder extends BaseActivity
{
	...
	private static final String CASH_PREFERENCE = "CashState";
...
//	DateHandler dateHandler;
	...
	private void init() {
		...
		CheckBox cbCash = (CheckBox)findViewById(R.id.cbCreateOrderCash);
		SharedPreferences sp = getPreferences(MODE_PRIVATE);
		cbCash.setChecked(sp.getBoolean(CASH_PREFERENCE, false));
...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
			...
			e.putBoolean(CASH_PREFERENCE, cash.isChecked());
			e.commit();
