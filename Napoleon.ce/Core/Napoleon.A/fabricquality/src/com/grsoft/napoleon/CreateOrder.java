...
//	DateHandler dateHandler;
	...
	private void init() {
		...
		cfg.key = "Склады";
		config.read();
		o.whIndex = DialogHelper.makeListWithKey(cfg.value, sklads, o.whCode);
		if(o.whIndex < 0) {
			o.whIndex = 0;
			if(sklads.size() > 0)
				o.whCode= sklads.get(0).key.toString();
		}
		String whText = "";
		if(o.whIndex < sklads.size()) {
			whText = "Склад: " + sklads.get(o.whIndex).value;
		}
		((TextView)findViewById(R.id.tvSklads)).setText(whText);
