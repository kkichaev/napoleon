...
public class ReturnPriceCount extends PriceCount {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if( NapoleonAppBase.IS_PRESELLING_PROGRAM )
	...
	@Override protected boolean getStartInPack() { return NapoleonAppBase.IS_PRESELLING_PROGRAM ? false : super.getStartInPack(); }
}
