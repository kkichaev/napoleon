...
public class QuestEdit extends Activity implements OnClickListener, QuestPhoto{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		View dv = View.inflate(this, R.layout.quest_description, null);
		TextView tv = (TextView) dv.findViewById(R.id.tvDescr);
