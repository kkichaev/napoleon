...
public class VisitEdit extends RegDurationActivity
	implements SendResultListener, PhotoClickHandler.EventHandler
{
...
//		edNotes.setInputType(InputType.TYPE_NULL);
		...
		if( Features.CANT_SEND_SCRIPT_PART ) {
			if(ScriptImpl.containsDocument(DocType.getCurDoc().getObjectName(), visit.getData().created, visit.getId()))
