...
public class DTaskEdit extends Activity implements RejectAction {
	public static Class<? extends DTaskEdit> activity = DTaskEdit.class;
	protected DTaskImpl doc = new DTaskImpl();
	...
	protected int getLayoutID() { return R.layout.dtaskedit;}
