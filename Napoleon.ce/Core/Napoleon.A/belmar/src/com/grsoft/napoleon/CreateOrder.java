...
//	DateHandler dateHandler;
	...
	private void init() {
		...
		Spinner spvidOpl = (Spinner) findViewById(R.id.spVidOpl);
		DialogHelper.loadSpinnerFromConfig(config, "ВидОплаты", new ArrayList<CharSequence>(), spvidOpl, o.vidOpl-1);
...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
			...
			Spinner spvidOpl = (Spinner) findViewById(R.id.spVidOpl);
			o.vidOpl = spvidOpl.getSelectedItemPosition() + 1;
