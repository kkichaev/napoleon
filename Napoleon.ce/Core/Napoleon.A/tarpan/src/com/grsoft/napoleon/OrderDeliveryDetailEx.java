...
public class OrderDeliveryDetailEx extends OrderDeliveryDetail {
	...
	void editQty(final OrderItem orderItem) {
		InputNumberDlg.open(OrderDeliveryDetailEx.this, 
...
//
//					InputNumberDlg.open(OrderDeliveryDetailEx.this, new InputNumber() {
//
//						@Override
//						public int getValue() {
...
//	}
	...
	class Adapter extends OrderDeliveryItemsAdapter {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			tv = (TextView) v.findViewById(R.id.tvDispatch);
			if( tv != null ) {
				tv.setTag(item);
				tv.setOnClickListener(openqty);
			}
