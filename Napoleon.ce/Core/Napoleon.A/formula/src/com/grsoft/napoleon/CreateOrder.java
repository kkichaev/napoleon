...
//	DateHandler dateHandler;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		rbNakl = (RadioButton) findViewById(R.id.rbNakl);
		rbFact = (RadioButton) findViewById(R.id.rbFact);
...
//		dateHandler = new DateHandler((TextView)findViewById(R.id.tvDate), o.date, DIALOG_DATE_PICKER_ID);
		...
		if(o.fact == 0)
			rbNakl.setChecked(true);
		else
			rbFact.setChecked(true);
