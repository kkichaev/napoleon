...
public class CreateOrder extends BaseActivity
{
	...
	private void init() {
        ...
        ListView lv = (ListView)findViewById(R.id.lvProps);
        lv.setAdapter(new PropsAdapter((OrgEx)oi.getData()));
	}
	...
	private void updateDisplayDelay() {
		((TextView)findViewById(R.id.tvDelay)).setText(order.getData().delay);
	}
	...
	class PropsAdapter extends BaseAdapter {
		...
		public PropsAdapter(OrgEx o) {
			org = o;
		}
		
		@Override public int getCount() { return org.params.size(); }

		@Override public Object getItem(int position) {
			return (position < org.params.size()) ? org.params.get(position) : null;
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if( convertView == null )
				convertView = View.inflate(CreateOrder.this, R.layout.prop_row, null);
			
			OrgParam op = (OrgParam)getItem(position);
			if( op != null ) {
				TextView tv;
				tv = (TextView)convertView.findViewById(R.id.tvKey);
				tv.setText(op.key);

				tv = (TextView)convertView.findViewById(R.id.tvValue);
				tv.setText(op.value);
			}
			return convertView;
		}
