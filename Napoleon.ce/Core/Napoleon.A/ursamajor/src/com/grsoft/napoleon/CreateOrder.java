...
//	DateHandler dateHandler;
	...
	private void init() {
		...
		DialogHelper.loadSpinnerFromConfig(config, "СтатусыЗаказов", new ArrayList<CharSequence>(), spState, o.state);
...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
			...
			Spinner spState = (Spinner) findViewById(R.id.spState);
			CharSequence cs = (CharSequence) spState.getSelectedItem();
			if(cs != null)
				o.state = cs.toString();
