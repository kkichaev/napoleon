...
public class CreateOrder extends BaseActivity
{
	...
	private static final int DIALOG_DATE_PICKER_ID2 = 2;
	...
	private void init() {
		...
		dlvDateHandler = new DateHandler((TextView)findViewById(R.id.tvDlvDate), o.dlvDate, DIALOG_DATE_PICKER_ID2);
	...
	protected Dialog onCreateDialog(int id) {
		switch(id) {
			...
			case DIALOG_DATE_PICKER_ID2:
				return dlvDateHandler.createDialog();
		}
	...
	class OKClickListener extends OnClickListenerToNotify {
		...
		private void okDone(boolean updateSumType) {
			...
			o.dlvDate = dlvDateHandler.getDate();
