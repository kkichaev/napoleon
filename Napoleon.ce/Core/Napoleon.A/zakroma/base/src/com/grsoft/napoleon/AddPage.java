...
public class AddPage extends Activity {
	...
	private void init() {
		...
		dateHandler = new DateHandler((TextView)findViewById(R.id.tvTTNDate), o.collectDate, DATE_PICK_DIALOG);
	...
	public void update(OrderImpl order) {
		...
		o.collectDate = dateHandler.getDate();
	}
