...
//	TimeHandler timeHandler;
	...
	private void init() {
		...
		num.setText(o.ordNumber);
		
		TextView tv = (TextView)findViewById(R.id.tvDiscountInfo);
		if(org.discount != 0)
			tv.setText("Клиентская скидка: " + Util.IntToScaleStr(org.discount, Consts.SUM_SCALE) + " %");
		else
		...
		DialogHelper.loadSpinnerWithKey(config, "СкладыТоваров", new ArrayList<KeyValue>(), 
				(Spinner)findViewById(R.id.spSklad), o.whId);
...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
			...
			KeyValue kv = (KeyValue) ((Spinner)findViewById(R.id.spSklad)).getSelectedItem();
			if( kv != null )
				o.whId = kv.key.toString();
//			o.whCode = ((Spinner)findViewById(R.id.spSklad)).getSelectedItemPosition();
			...
			o.remark = ((EditText)findViewById(R.id.edCreateOrderNotes)).getText().toString();
			o.ordNumber = ((EditText)findViewById(R.id.edNumber)).getText().toString();
			...
			DocHelper.saveDocNumber(DataObjectInfo.getInstance().getTableName(o.getClass()), o.ordNumber);
			if(!editMode)
