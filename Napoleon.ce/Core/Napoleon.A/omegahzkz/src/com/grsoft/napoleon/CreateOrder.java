...
public class CreateOrder extends BaseActivity
{
	...
	private ArrayList<CharSequence> vds = new ArrayList<CharSequence>();
...
//	DateHandler dateHandler;
	...
	private void init() {
		...
		Spinner spVD = (Spinner) findViewById(R.id.spVD);
		DialogHelper.loadSpinnerFromConfig(config, "ВидДокумента", vds, spVD, o.vd);
...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
			...
			Spinner sVd = (Spinner) findViewById(R.id.spVD);
			o.vd = sVd.getSelectedItemPosition();
