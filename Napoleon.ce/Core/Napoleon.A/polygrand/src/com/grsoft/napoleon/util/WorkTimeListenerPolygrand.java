...
public class WorkTimeListenerPolygrand implements OnClickListener {
	NapoleonApp app;
	ImageButton btnStart;
	View btnNewDoc;
	String id;
	
	public WorkTimeListenerPolygrand(NapoleonApp app, String id, ImageButton btnStart, View newDoc) {
		...
		btnStart.setImageResource(inWork ? R.drawable.stop : R.drawable.start);
	...
	public void onClick(View v) {
		...
		btnStart.setImageResource(inWork.length() > 0 ? R.drawable.stop 
				: R.drawable.start);
	}}
