...
public class RemnantsEdit extends Activity implements OnClickListener {
	...
	private void okClick() {
		...
		item.qty = Util.StrToScale(edQty.getText().toString(), Consts.QTY_SCALE);
		item.face = Util.StrToScale(edFace.getText().toString(), Consts.QTY_SCALE);
		item.cost = Util.StrToScale(edCost.getText().toString(), Consts.SUM_SCALE);
