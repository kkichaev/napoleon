...
//	DateHandler dateHandler;
	...
	private CheckBox cbOpenClient;
	private EditText edOpenClient;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cbOpenClient = (CheckBox)findViewById(R.id.cbOpenClient);
		edOpenClient = (EditText)findViewById(R.id.edOpenClient);
...
//		dateHandler = new DateHandler((TextView)findViewById(R.id.tvDate), o.date, DIALOG_DATE_PICKER_ID);
		...
		edOpenClient.setText(o.textClient);
		cbOpenClient.setChecked(o.openClient != 0);
		
		cbOpenClient.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			
			@Override
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				if (!isChecked)
					edOpenClient.setText("");
				
				edOpenClient.setEnabled(isChecked);
			}
		});
		
		edOpenClient.setEnabled(cbOpenClient.isChecked());
	}
...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
			...
			o.openClient = cbOpenClient.isChecked() ? 1 : 0;
			o.textClient = edOpenClient.getText().toString().trim();
