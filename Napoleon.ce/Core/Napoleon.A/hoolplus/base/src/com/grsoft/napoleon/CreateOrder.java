...
//	DateHandler dateHandler;
	...
	private void init() {
		...
		int selected = -1;
		final ArrayList<Firm> firms = new ArrayList<Firm>();
		Firm fe = new Firm();
		DbReader r = new DbReader();
		boolean bdo = r.select(fe, fe.getTableName(), null, "name");
		while(bdo != false) {
		...
		ArrayAdapter<Firm> fa = new ArrayAdapter<Firm>(this, R.layout.simple_spinner_layout, firms);
