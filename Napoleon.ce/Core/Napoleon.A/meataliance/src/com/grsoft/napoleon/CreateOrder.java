...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
	...
	private void disableExtraViews(){
		((TextView)findViewById(R.id.disable1)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.tvTime)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.tvDelay)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.cbCreateOrderCash)).setVisibility(View.GONE);
	}
}
