...
//	DateHandler dateHandler;
	...
	private void init() {
		...
		DialogHelper.loadSpinnerFromConfig(config, "ФормаОплаты", new ArrayList<CharSequence>(), spPayType, o.payType);
		...
		((CheckBox)findViewById(R.id.cbConsign)).setChecked(o.consign == 1);
		((CheckBox)findViewById(R.id.cbPerech)).setChecked(o.perech == 1);
...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
			...
			Spinner spPayType = (Spinner) findViewById(R.id.spPayType);
			Object psel = spPayType.getSelectedItem();
			if(psel != null)
				o.payType = psel.toString();
			
			o.consign = ((CheckBox)findViewById(R.id.cbConsign)).isChecked() ? 1 : 0;
			o.perech = ((CheckBox)findViewById(R.id.cbPerech)).isChecked() ? 1 : 0;
