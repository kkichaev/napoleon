...
public class CheckMissedTimer extends Timer{
	...
	private void showNotify() {
        ...
        Notification not = new Notification.Builder(service)
        ...
        NotificationManager m = (NotificationManager)service.getSystemService(Context.NOTIFICATION_SERVICE);
		m.notify(R.id.taskmissed, not);
	}
