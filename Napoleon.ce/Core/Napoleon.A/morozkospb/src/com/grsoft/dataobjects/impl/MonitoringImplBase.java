...
public abstract class MonitoringImplBase<T extends Monitoring> extends CreatableDocument<Monitoring> 
...
//		);
	...
	private MonitoringItem initItem(String id) {
		MonitoringItem res = new MonitoringItem();
		res.id = id;
		data.items.add(res);
		return res;
	}
	...
	public DataObject findItem(String itemId) {
		...
		for(MonitoringItem i : data.items)
