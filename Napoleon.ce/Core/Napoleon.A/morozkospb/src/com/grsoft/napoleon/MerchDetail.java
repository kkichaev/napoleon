...
public class MerchDetail extends BaseActivity implements OnClickListener, OnChildClickListener, DataSetNotify, SendResultListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if( Features.CANT_SEND_SCRIPT_PART ) {
			if(ScriptImpl.containsDocument(MerchDoc.instance().getObjectName(), doc.getData().created, doc.getId()))
