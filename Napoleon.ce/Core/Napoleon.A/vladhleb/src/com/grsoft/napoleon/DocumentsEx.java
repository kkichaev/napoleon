...
public class DocumentsEx extends Documents {
	...
	protected void onGPSReceived() {
		if(DocType.getCurDoc() == OrgCoordDoc.instance()){
			OrgCoordDoc.setGPS(org.getData().id);
			if(adapter != null)
				adapter.setDocType((DocType) OrgCoordDoc.instance());
		}
	}
	...
	protected void adjustViewForDocType(DocType docType) {
		...
		if(docType == OrgCoordDoc.instance())
			btnGpsStatus.setEnabled(false);
	}
