...
public class NapoleonApp extends Application {
	...
	private void initDocTypes() {
		...
		DataObjectInfo.getInstance().replacePrimaryKey(Payment.class, "id,number,payType");
		
		IncassEdit.IncassActivity = IncassEditEx.class;
		Documents.DocumentsActivity = DocumentsEx.class;
