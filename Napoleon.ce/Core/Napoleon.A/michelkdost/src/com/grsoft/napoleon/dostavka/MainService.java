...
//		}
		...
		List<DocExportListener> output = DocTypeBase.getDocuments(true, true);
		...
		if(!prev.equals(p.login)){
			...
			p.indata.add(new Hitching(Route.class));
			p.indata.add(new Hitching(RouteItem.class));
		}
	...
	private void sync(final boolean clear, Params param){
