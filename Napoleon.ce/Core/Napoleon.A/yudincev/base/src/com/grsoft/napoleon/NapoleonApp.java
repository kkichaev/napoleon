...
public class NapoleonApp extends Application {
	...
	private void initDocTypes() {
		...
		doi.replaceListType(PriceEx.class, "cost", CostItemEx.class);
		...
		UpdateDB.addHitchingCtor(new HitchingCtor(){@Override public Hitching create() { return new RcvNewHitching(PricePhotoServ.class);	}}, UpdateDB.GEN_DATA_HITCHING);
	}
