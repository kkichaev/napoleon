...
public class CreateOrder extends BaseActivity
{
	...
	class OKClickListener extends OnClickListenerToNotify {
		...
		public void onClick(View v) {
			...
			if (editMode && kv != null && kv.key.toString().equals(((OrderEx)order.getData()).costCode) == false)
				askToApplyNewSumType(v.getContext(), CostStrategyEx.getCostIndex(kv.key.toString()));
			else 
				okDone(false);
		}
