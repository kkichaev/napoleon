...
public class NapoleonEx extends Napoleon {
	...
	public static HashMap<String, Long> outDebs = new HashMap<String, Long>();
	...
	private void setInfo(AlertDialog dialog) {
		...
		long outDeb = getOutDebs(infoOrg);
	...
	private long getOutDebs(OrgImpl org) {
		Long v = outDebs.get(org.getData().id);
		return ((v != null) ? v : 0);
	}

	private long getBalance(OrgImpl org) {
