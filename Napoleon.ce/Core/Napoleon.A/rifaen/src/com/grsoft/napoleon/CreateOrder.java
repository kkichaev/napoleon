...
public class CreateOrder extends BaseActivity
{
	...
	static final String stopComment = "СТОП ОТГРУЗКА!";
...
//	DateHandler dateHandler;
	...
	void checkStopDelivery() {
		if(order.isEditable() && StopHelper.stopDelivery(order.getId())) {
			Order o = order.getData();
			if(o.remark.contains(stopComment) == false) {
				o.remark = stopComment + " " + o.remark;
			}
		}
	}
