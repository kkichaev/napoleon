...
public class PriceCountEx extends PriceCount {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		calcResult = new BroadcastReceiver() {
			...
			public void onReceive(Context context, Intent intent) {
				if (intent != null)
					onChangeCost(Util.StrToScale(intent.getStringExtra(Calculator.CALCULATOR_RESULT_VALUE), Consts.SUM_SCALE));
			}
		};
	...
	protected void doCostChange() {
		...
		String val = Util.IntToScaleStr(priceVal, Consts.SUM_SCALE, ".");
