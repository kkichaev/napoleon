...
//	DateHandler dateHandler;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spNumGroup = (Spinner) findViewById(R.id.spNumGroup);
	...
	private void init() {
		...
		Spinner spPay = (Spinner) findViewById(R.id.spPayType);
		DialogHelper.loadSpinnerFromConfig(config, "ТипОплаты", new ArrayList<CharSequence>(), spPay, o.payType);
		...
		DialogHelper.loadSpinnerWithKey(config, "НомГруп", new ArrayList<KeyValue>(), spNumGroup, o.numgroup);
...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
			...
			o.payType = ((Spinner)findViewById(R.id.spPayType)).getSelectedItemPosition();
			o.dogovor = ((OrgDog)((Spinner)findViewById(R.id.spDogovor)).getSelectedItem()).id;
			...
			value = (KeyValue)spNumGroup.getSelectedItem();
			
			if(value != null)
				o.numgroup = value.key.toString();
