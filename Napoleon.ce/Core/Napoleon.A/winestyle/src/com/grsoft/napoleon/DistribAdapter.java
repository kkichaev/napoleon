...
public class DistribAdapter extends BaseAdapter {
	List<OrgMatrix> data = new ArrayList<OrgMatrix>();
	DistribEdit activity;
	
	public DistribAdapter(DistribEdit activity, String id) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null)
			convertView = View.inflate(activity, R.layout.distribeditrow, null);
