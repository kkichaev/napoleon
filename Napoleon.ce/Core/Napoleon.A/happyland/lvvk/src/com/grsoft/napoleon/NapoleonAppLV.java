...
public class NapoleonAppLV extends Application  {
	...
	class OrderEditor implements OrderImpl.PropertiesEditor {
		...
		public void edit(Context ctx, OrderImpl order, boolean isOldOrder) {
			CreateOrderLV.open(ctx, order, isOldOrder);
		}
	}
	...
	private void initDocTypes() {
		...
		UpdateDB.initUI = new ViewInitializer() {
			@Override public void init(Activity activity) { activity.findViewById(R.id.cbRemains).setVisibility(View.INVISIBLE); }
		};
