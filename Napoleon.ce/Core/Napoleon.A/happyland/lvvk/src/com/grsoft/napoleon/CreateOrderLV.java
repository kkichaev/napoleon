...
public class CreateOrderLV extends BaseActivity
{
...
//	DateHandler dateHandler;
	...
	public static void open(Context context, OrderImpl order, boolean editOldOrder) {
		Intent i = new Intent(context, CreateOrderLV.class);
	...
	private void init() {
		...
		findViewById(R.id.tvDate).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(CreateOrderLV.this, CalendarActivity.class);
...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
			...
			if(!editMode)
				Warehouse.open(CreateOrderLV.this, order, false);
