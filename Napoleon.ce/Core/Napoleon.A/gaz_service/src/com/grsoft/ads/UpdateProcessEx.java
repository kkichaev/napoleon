...
import com.grsoft.ads.database.PauseHitching;
...
public class UpdateProcessEx extends UpdateProcess {
	public UpdateProcessEx(Context context, LockOwner lockOwner){
		super(context, lockOwner);
	}
