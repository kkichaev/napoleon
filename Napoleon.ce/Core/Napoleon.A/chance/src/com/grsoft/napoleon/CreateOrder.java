...
//	DateHandler dateHandler;
	...
	private void init() {
		...
		DialogHelper.loadSpinnerFromConfig(config, "ВидОплаты", new ArrayList<CharSequence>(), spPayType, o.payType);
...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
			...
			Spinner spPayType = (Spinner) findViewById(R.id.spPayType);
			CharSequence val = (CharSequence) spPayType.getSelectedItem();
			if(val != null)
				o.payType = val.toString();
