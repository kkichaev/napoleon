...
//	DateHandler dateHandler;
	...
	private void init() {
		...
		((Spinner)findViewById(R.id.spDelivery)).setSelection(o.delivery);
...
//		dateHandler = new DateHandler((TextView)findViewById(R.id.tvDate), o.date, DIALOG_DATE_PICKER_ID);
	...
	private void initOrder(Order o, Org org) {
		int i = Features.COST_MANAGER.getCostIndex(org.id);
		if( i < 0 ) i = 0;
		else i++;
		o.sumType =  i;
	}
...
//				o.sumType = costType;
			...
			o.delivery = ((Spinner)findViewById(R.id.spDelivery)).getSelectedItemPosition();
