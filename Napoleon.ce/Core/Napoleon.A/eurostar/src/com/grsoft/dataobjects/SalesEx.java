...
public class SalesEx extends Sales implements IOrder{
	//-------------- IOrder firelds -----------------------------
		...
		@Override
		public String getFirmCode() { return supplyercode;	}
		@Override
		public void setFirmCode(String val) { supplyercode = val; }
		@Override
		public void setDocNumber(String val) { number = val; }
		@Override
		public String getDocNumber() { return number; }
}
