...
public class CreateOrder extends BaseActivity
{
	...
	private void init() {
		...
		DialogHelper.loadSpinnerFromConfig(config, "Склады", new ArrayList<CharSequence>(), (Spinner)findViewById(R.id.spWh), o.whIndex);
	...
	class OKClickListener extends OnClickListenerToNotify {
		...
		private void okDone(boolean updateSumType) {
			...
			int value = ((Spinner) findViewById(R.id.spFirma)).getSelectedItemPosition();
			Spinner spPrices = (Spinner) findViewById(R.id.spPrices);
			int costType = spPrices.getSelectedItemPosition();
			...
			value = ((Spinner) findViewById(R.id.spWh)).getSelectedItemPosition();
			if( value >= 0 )
				o.whIndex = value;
