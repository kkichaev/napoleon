...
bool GRServer::ParseStr(Token *dest, StringStream &stream, const SessionObject* object,
                        IResolver &resolver, const wchar_t *endStmt, bool needDebug)
{
