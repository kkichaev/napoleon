...
import com.grsoft.database.RemovedReturnHitching;
...
public class NapoleonApp extends NapoleonAppBase {
	...
	protected void defineNewType() {
		...
		NapoleonServiceW.priceUpdateHitchings.add(orh);
		

		Hitching rrh = new RemovedReturnHitching();
		ReadService.recievers.addAll(NapoleonServiceW.priceUpdateHitchings);
	...
	protected void initFeatures() {
		...
		Main.docMenuPrepared.add(new MenuPrepareHitching() {
			...
			public void menuPrepared(List<MenuHandler> menu, final Activity activity) {
				menu.add(new MenuHandler("Отчет по инкассациям", new Runnable() {
