...
public class BitmapUtils {
  ...
  public static Bitmap getBitmap(ImageProxy image) {
    ...
    ByteBuffer nv21Buffer =
        yuv420ThreePlanesToNV21Mono(image.getImage().getPlanes(), image.getWidth(), image.getHeight());
//        yuv420ThreePlanesToNV21(image.getImage().getPlanes(), image.getWidth(), image.getHeight());
    return getBitmap(nv21Buffer, frameMetadata);
  }

  static ByteBuffer yuv420ThreePlanesToNV21Mono(Plane[] yuv420888planes, int width, int height) {
    ...
    if (areUVPlanesNV21(yuv420888planes, width, height)) {
      ...
      Arrays.fill(out, imageSize, imageSize + 2 * imageSize / 4, (byte)0);
    } else {
