...
import com.grsoft.napoleon.documents.SalesHistoryEx;
...
public class NapoleonApp extends NapoleonAppBase {
	...
	protected void defineNewType() {
		...
		super.defineNewType();
		SalesHistory.HistClass = SalesHistoryEx.class;
		...
		doi.replaceListType(PriceEx.class, "whQty", PriceQtyItemEx.class);
		...
		doi.replaceIndexes(Price.class, "analog");
	}
	...
	public void onCreate() {
		...
		UpdateDB.addHitchingCtor(new HitchingCtor(){
			...
			public Hitching create() {
				return new RcvNewHitching(MasterOrder.class);
			}
