...
public class CostInputDlg {
	...
	public static void open(final Context context, final InputNumber inputNumber, int vMinCost){
		...
		tv.setText("мин.цена: " + Util.IntToScaleStr(vMinCost, scale, Util.DEC_DELIM, hideRest));
