...
public class RestoreDocProceededEx extends RestoreDocProceeded {
    SQLiteStatement stmt;

    public RestoreDocProceededEx() {
        super(OrderProceededEx.class, "ArchiveOrderProceeded", "created");
    }

    public RestoreDocProceededEx(int days) {
        super(OrderProceededEx.class, "ArchiveOrderProceeded", "created");
        makeDocReceiveCondition("created", 0, days);
    }
