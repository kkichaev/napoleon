...
public class OrderPrintItems extends DataSource {
    protected List<OrderItemPrint> items = new ArrayList<>();
    ...
    protected OrderPrint owner;

    public OrderPrintItems(OrderPrint owner) {
        this.owner = owner;
    }

    public void add(OrderItemPrint item) { items.add(item); }

    public List<OrderItemPrint> getItems() { return items; }
    ...
    public void calculate() {
        ...
        OrderItemPrint sip = items.get(index);
        pagepack += sip.pack;
        ipageqty += sip.iqty;
