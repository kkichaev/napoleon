...
//	DateHandler dateHandler;
	...
	private void init() {
		...
		DialogHelper.loadSpinnerWithKey(config,"Организация", new ArrayList<>(), spFirma, o.firmCode );
//		DialogHelper.loadSpinnerFromConfig(config, "Организация", firms, spFirma, o.supplyer);
		...
		CheckBox cb = findViewById(R.id.cbAgr);
		cb.setChecked(o.personalAgreement > 0);
		cb.setEnabled(org.personalAgreement > 0);
...
//		dateHandler = new DateHandler((TextView)findViewById(R.id.tvDate), o.date, DIALOG_DATE_PICKER_ID);
	...
	private void initOrder(OrderEx o, OrgEx org) {
		...
		o.personalAgreement = org.personalAgreement;
...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
			...
			o.personalAgreement = ((CheckBox)findViewById(R.id.cbAgr)).isChecked() ? 1 : 0;
