...
import com.grsoft.dataobjects.PlanData;
...
public class PlanSync extends NetworkAsyncTask {
	public static final String START_SYNC = "PlanSync.start_sync";
	public static final String FINISH_SYNC = "PlanSync.start_sync";
	public static final String LAST_SYNC_TIME = "PlanSync.last_sync_time";
	
	Context context;
	TextView tvLastSync;
	
	public PlanSync(Context context) {
	...
	protected Boolean doInBackground(Void... params) {
		...
		rcv.add(new RcvNewHitching(PlanData.class));
		ReportHitching tsr = new ReportHitching("planrequest", arg1, rcv);
