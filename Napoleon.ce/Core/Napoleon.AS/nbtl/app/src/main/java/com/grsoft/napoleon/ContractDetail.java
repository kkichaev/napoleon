...
public class ContractDetail extends BaseActivity implements DataSetNotify {
	...
	private void intiView() {
		...
		btnEdit.setOnClickListener(editClick);
		btnPlan.setOnClickListener(planClick);
	}
	
	private OnClickListener editClick = new View.OnClickListener() {
		@Override public void onClick(View v) {	ContractEdit.open(v.getContext(),  document.getRowid(), true); }
	};
	
	private OnClickListener planClick = new View.OnClickListener() {
		@Override public void onClick(View v) {	PlanView.open(v.getContext(),  document.getData().def, document.getId()); }
	};
	...
	class Adapter extends BaseAdapter{
		...
		public View getView(int position, View view, ViewGroup parent) {
			...
			if(item != null){
				...
				tv.setText(Html.fromHtml(pe.name + " <i>" + pe.group + "</i>"));
