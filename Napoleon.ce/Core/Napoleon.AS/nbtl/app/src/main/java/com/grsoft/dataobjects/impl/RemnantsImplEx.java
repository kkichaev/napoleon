	...
	public void editItem(final long itemRowid, final Context context) {
		...
		InputNumberDlg.open(context, new InputNumber() {
			...
			public void applayInput(int value, Object... params) {
				...
				int factQty = (int) Util.StrToScale(((EditText) dlg.findViewById(R.id.edFact)).getText().toString(), Consts.QTY_SCALE);
				int inputQty = (int) Util.StrToScale(((EditText) dlg.findViewById(R.id.edInput)).getText().toString(), Consts.QTY_SCALE);
				int unloadQty = (int) Util.StrToScale(((EditText) dlg.findViewById(R.id.edUnload)).getText().toString(), Consts.QTY_SCALE);
				int brakQty = (int) Util.StrToScale(((EditText) dlg.findViewById(R.id.edBrak)).getText().toString(), Consts.QTY_SCALE);
