...
public class NapoleonAppBase extends Application {
	...
	public void onCreate() {
		...
		Main.Handler = new Main.Events() {
			@Override public void onStart(Main sender) { startMainService(); }
			@Override public void setDefaultDocType(Main sender) { setDefDocType(); }
			@Override public void onExit(Main sender) { exit(); }
		};
	...
	protected void initActivity() {
		...
		// не дает изменить актиыити для продаж
