...
public class ManagePhotoDlg extends DialogFragment {
	...
	public static final  String REJECT_DELETE = "reject_delete";
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		if(b != null){
			...
			boolean rd = b.getBoolean(REJECT_DELETE);
			...
			builder.setItems(items.toArray(new CharSequence[items.size()]), itemClick());
		}
...
//				uri = FileProvider.getUriForFile(c,
//						getContext().getString(R.string.fileprovider_authorities), new File(path));
//			}else
