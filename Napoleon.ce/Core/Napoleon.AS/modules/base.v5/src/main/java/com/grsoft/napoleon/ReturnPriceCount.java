...
public class ReturnPriceCount extends PriceCount implements OrderImplBase.UpdateQtyHandler {
	...
	public static void open(Context context, long priceRowid, ReturnImplV5 doc) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (document != null && document instanceof ReturnImplV5) {
			((ReturnImplV5)document).setUpdateQtyHandler(this);
	...
	protected void refreshData() {
		...
		if (document != null && document instanceof ReturnImplV5) {
			...
			ReturnItem re = (ReturnItem) ((ReturnImplV5)document).findItem(itemId);
	...
	class DlvAdapter extends BaseAdapter {
		...
		public void refresh(String orgId, String itemId) {
			 item = (ReturnItem) ((ReturnImplV5)document).findItem(itemId);
			 if( item == null)
				 item = new ReturnItem();
