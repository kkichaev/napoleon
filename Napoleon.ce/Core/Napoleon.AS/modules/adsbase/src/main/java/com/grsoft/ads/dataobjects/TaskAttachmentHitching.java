...
public class TaskAttachmentHitching extends HitchOnSelect {
	public static final String ATTACH_DIRECTORY = Environment.getExternalStorageDirectory() + "/Ads/files/attachments/";
	private boolean enableExternalStore = false;
	
	public TaskAttachmentHitching(String id) {
		super(TaskAttachment.class, "TaskAttachment");
	...
	public void onRead(RawObject rawObject) throws RuntimeException {
		if (enableExternalStore){
			TaskAttachment a = (TaskAttachment) rawObject.createDataObject(TaskAttachment.class);
