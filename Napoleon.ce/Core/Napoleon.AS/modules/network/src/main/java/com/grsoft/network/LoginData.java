...
public class LoginData extends UserInfo
{
	...
	public LoginData(String user, String password, String impersonate,  Context ctx, String uuid, String serverCode)
	{
		super(user, password, impersonate, uuid, serverCode);
		this.setDuration(ctx);
	}

	public LoginData(String user, String password, String impersonate,  Context ctx)
	{
		super(user, password, impersonate, "", "");
		this.setDuration(ctx);
	}
	...
	public static int readDuration(Context ctx){
		SharedPreferences prf = ctx.getSharedPreferences(LOGIN_PREF, Context.MODE_PRIVATE);
