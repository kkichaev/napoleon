...
//	DateHandler dateHandler;
	...
	private void init() {
		...
		Spinner spCType = findViewById(R.id.spCalcType);
		DialogHelper.loadSpinnerFromConfig(config, "ВариантРасчета", new ArrayList<CharSequence>(), spCType, o.calcType);
...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
			...
			String selCT = (String) ((Spinner)findViewById(R.id.spCalcType)).getSelectedItem();
			if(selCT != null)
				o.calcType = selCT;
