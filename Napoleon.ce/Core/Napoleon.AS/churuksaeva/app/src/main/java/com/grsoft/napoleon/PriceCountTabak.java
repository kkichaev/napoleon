...
public class PriceCountTabak extends PriceCount implements OrderImplBase.UpdateQtyHandler {
    ...
    public void itemUpdated(OrderItem item, Order order, boolean isNewItem) {
        ...
        se.itemQty = Util.StrToScale(((EditText)findViewById(R.id.edCountQty)).getText().toString(), Consts.QTY_SCALE);
        se.packQty = Util.StrToScale(((EditText)findViewById(R.id.edCountPack)).getText().toString(), Consts.QTY_SCALE);
    }

    PCQtyData getPCQty() {
        PCQtyData ret = new PCQtyData();
        ret.pq = Util.StrToScale(((EditText)findViewById(R.id.edCountPack)).getText().toString(), Consts.QTY_SCALE);
        ret.iq = Util.StrToScale(((EditText)findViewById(R.id.edCountQty)).getText().toString(), Consts.QTY_SCALE);
        return ret;
    }
}
