	...
	protected void initChildActivity() {
		...
		UpdateDB.addHitchingCtor(new HitchingCtor(){
			...
			public List<Hitching> createList() {
				return Arrays.asList(new Hitching[]{new RcvNewHitching(LayoutDef.class),
					new RcvNewHitching(LayoutFailureCause.class)});
			}
