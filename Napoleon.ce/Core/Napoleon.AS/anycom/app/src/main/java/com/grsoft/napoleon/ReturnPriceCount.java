...
public class ReturnPriceCount extends PriceCount {
	...
	@Override
	protected boolean havePriceMover() {
		return false;
	}
	...
	static class DlvKeySum extends DeliveryKey {
		public int qty;
		public int cost;
		public String uid;
	...
	static class DlvData {
		...
		public DeliveryItemEx item;

		public DlvData(Delivery doc, DeliveryItemEx item) {
