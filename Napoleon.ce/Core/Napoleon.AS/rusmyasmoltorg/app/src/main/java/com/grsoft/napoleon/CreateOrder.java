...
//	DateHandler dateHandler;
	...
	private void init() {
		...
		spDlvType = findViewById(R.id.spDlvType);
...
//		dateHandler = new DateHandler((TextView)findViewById(R.id.tvDate), o.date, DIALOG_DATE_PICKER_ID);
		...
		spDlvType.setAdapter(new ArrayAdapter<String>(this, R.layout.simple_spinner_layout, getResources().getStringArray(R.array.dlv_type)));
		spDlvType.setSelection(o.dlvType, true);
	}
...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
			...
			o.dlvType = spDlvType.getSelectedItemPosition();
