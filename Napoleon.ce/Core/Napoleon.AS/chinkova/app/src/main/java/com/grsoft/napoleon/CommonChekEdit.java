...
public class CommonChekEdit extends CommonIncassEditBase {
	...
	@Override
	protected void newFirmSelected() {
		super.newFirmSelected();
		refreshChek();
	}
	...
	protected void initUI() {
		...
		btnAdd.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				df = new SelectCheck(CommonChekEdit.this);
...
//					" and created <= " + Long.toString(Util.getDayEnd(dateTo).getTime());
	...
	public static class SelectCheck extends SelectDialog {
		...
		CommonChekEdit context;

		public SelectCheck(CommonChekEdit context) {
		...
		public void prepareView(View view) {
			...
			listView.setAdapter(context.chekAdapter);
			...
			tvFrom.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					i.putExtra(ExtrasConst.DATE_TAG, context.dateFrom.getTime());
					context.startActivityForResult(i, DIALOG_FROM_ID);
				}
			});
			...
			tvEnd.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					Intent i = new Intent(context, CalendarActivity.class);
					i.putExtra(ExtrasConst.DATE_TAG, context.dateTo.getTime());
					context.startActivityForResult(i, DIALOG_TO_ID);
				}
			});
			refreshDate();
		}
		...
		public void refreshDate() {
			String txt = "Дата с <font color='blue'><u>" + Util.simpleDateFormat.format(context.dateFrom) + "</u></font>";
			tvFrom.setText(Html.fromHtml(txt));
			
			txt = " по <font color='blue'><u>" + Util.simpleDateFormat.format(context.dateTo) + "</u></font>";
			tvEnd.setText(Html.fromHtml(txt));
		}
		
		@Override
		public void onOKButtonPressed(View result) {
			if(context.doc.isExported())
				return;
			
			HashMap<Date, CommonChekItem> items = new HashMap<Date, CommonChekItem>();
			CommonChek cc =  (CommonChek)context.doc.getData();
	...
	public void dataChanged() {
		...
		spOrg.setEnabled((doc.isEditable() && doc.getData().items.size() == 0));
