...
//	DateHandler dateHandler;
	...
	private void init() {
		...
		Spinner spRoute = (Spinner) findViewById(R.id.spRoute);
		DialogHelper.loadSpinnerFromConfig(config, "Маршрут", new ArrayList<CharSequence>(), spRoute, o.route);
		...
		((CheckBox)findViewById(R.id.cbDebt)).setChecked(o.dolg != 0);
		((CheckBox)findViewById(R.id.cbSchF)).setChecked(o.schf != 0);
...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
			...
			Spinner spRoute = (Spinner) findViewById(R.id.spRoute);
			String route = (String)spRoute.getSelectedItem();
			if(route != null)
				o.route = route;
			...
			o.dolg = ((CheckBox)findViewById(R.id.cbDebt)).isChecked() ? 1 : 0;
			o.schf = ((CheckBox)findViewById(R.id.cbSchF)).isChecked() ? 1 : 0;
