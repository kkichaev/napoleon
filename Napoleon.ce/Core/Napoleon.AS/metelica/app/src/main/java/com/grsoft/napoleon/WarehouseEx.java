...
public class WarehouseEx extends Warehouse implements OnClickListener, android.content.DialogInterface.OnClickListener {
	...
	class TreeNodeCmpCost extends TreeNodeCmp{
		...
		public int compare(TreeNode n1, TreeNode n2) {
			...
			if (n1 instanceof PriceTreeNode && n2 instanceof PriceTreeNode) {
				p1.read(n1.getRowid());
				p1.close();
				int c1 = (int) getCost(p1.getData());
				
				p2.read(n2.getRowid());
				p2.close();
				int c2 = (int) getCost(p2.getData());
