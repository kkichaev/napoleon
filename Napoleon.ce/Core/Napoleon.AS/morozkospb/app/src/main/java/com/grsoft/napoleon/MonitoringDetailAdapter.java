...
public class MonitoringDetailAdapter extends BaseAdapter {
	private List<MonitoringItemMSPB> data = new ArrayList<MonitoringItemMSPB>();
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		MonitoringItemMSPB i = (MonitoringItemMSPB) getItem(position);
	...
	public void refresh(MonitoringImplBase<?> doc) {
		...
		for(MonitoringItemMSPB i : doc.getData().items)
			data.add(i);
