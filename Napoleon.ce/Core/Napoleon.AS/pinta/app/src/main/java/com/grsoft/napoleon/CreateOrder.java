		...
		if( Features.DELIVERY_ADDRESS ) {
			...
			if( v != null ) {
				...
				if( spAddress != null ) {
					...
					ArrayAdapter<KeyValue> aad = new ArrayAdapter<KeyValue>(this, R.layout.simple_spinner_layout, addresses);
					spAddress.setAdapter(aad);
...
//			o.date = timeHandler.adjustTime(dateHandler.getDate());
			...
			OrgDogovor od = (OrgDogovor) spFirma.getSelectedItem();
			if( od != null ) {
				o.firmCode = od.idOrg;
				o.dogovor = od.id;
