...
import com.grsoft.dataobjects.ServerDemoData;
import com.grsoft.network.ObjectExportListener;
import com.grsoft.network.RawObject;
import com.grsoft.network.exception.RuntimeException;

public class ServerDemoDataSendHitching implements ObjectExportListener {

	List<ServerDemoData> array = new ArrayList<ServerDemoData>();
	...
	@Override public String getObjectName() { return "DemoProjectData"; }
	...
	public void add(JsonElement elData) {
		...
		for(int i=0; i<a.size(); i++) {
			...
			if(el == null)
				continue;
			ServerDemoData data = ServerDemoData.load(el);
			if(data != null) {
				array.add(data);
			}
		}
