...
public class DeliveryDetail extends RegDurationActivity
{
	protected PriceImpl priceImpl;
	private ListView lvItems;
	protected DeliveryImplBase<? extends Delivery> delivery;
	LinesCountController linesController;
	private static final String TAG = "DeliveryDetail";
	
	public static Class<? extends Activity> activity = DeliveryDetail.class;
	...
	DeliveryImplBase<? extends Delivery> createDelivery() { return new DeliveryImpl(); }
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (delivRowId != ExtrasConst.INVALID_ID) {
			readDocument(delivRowId);
			orgImpl.getData().id = delivery.getData().id;
			orgImpl.read();	
			orgImpl.close();
		}
		else
		...
		LinesOnClickListener linesOnClickListener = new LinesOnClickListener(
				lvItems, btnLines, this, true);
		linesController = linesOnClickListener.getController();
//		btnLines.setOnClickListener(linesOnClickListener);
		
		updateTotalSum(delivery.sum(), delivery.weight());
	}
	
	@Override
	protected void onResume() {
		super.onResume();
		lvItems.setAdapter(createItemsAdapter());
	}
	
	protected DeliveryItemsAdapter createItemsAdapter() { return new DeliveryItemsAdapter(); }

	@Override
	protected void onSaveInstanceState(Bundle outState) {
		super.onSaveInstanceState(outState);
		outState.putLong(ExtrasConst.DOC_ROW_ID_STR, delivery.getRowid());
	}
	...
	{
		protected int getLayoutID() { return R.layout.orderdetail_list_row; }

		@Override
		public int getCount()
		{
			return delivery.getData().items.size();
		}

		@Override
		public Object getItem(int arg0)
		{
			return delivery.getData().items.get(arg0);
		}
		...
		public View getView(int arg0, View arg1, ViewGroup arg2)
		{
			...
			if (view == null)
				view = View.inflate(DeliveryDetail.this, getLayoutID(), null);
