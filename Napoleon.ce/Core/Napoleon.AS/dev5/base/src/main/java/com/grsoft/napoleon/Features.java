...
public class Features extends FeaturesBase{
    public static boolean OPEN_ASSORTIMENT_IN_REMNANTS = false;
    /**
	 * Скрывать логин **
	 */
	 ...
	 */
	public static int MIN_FOTO_WIDTH = 100;
	
	/**
	 * Максимальное разрешение камеры
	 */
	public static int MIN_FOTO_HEIGHT = 100;

	/**
	 * Максимальное разрешение камеры
	 */
	public static int MAX_FOTO_WIDTH = 3600;

	/**
	 * Максимальное разрешение камеры
	 */
	public static int MAX_FOTO_HEIGHT = 3600;
	 ...
	 */
	public static boolean IS_MARKET_VERSION = true;
	 ...
	 */
	public static boolean CONFIG_CHECK_PRICE_QTY = true;
	...
	public static boolean PRESENTATION_IN_DB = false;
	 ...
	 */
	public static boolean QTY_IN_PACK_IN_DOCS = true;
	 ...
	 */
	public static boolean UPD = true;
	...
	/**
	 * убираем файл .nomedia чтобы видеть фотки в галерее
	 */
	public static boolean SHARED_PICTURES = false;

	/**
	 * поиск по точному ID
	 */
	public static boolean SEARCh_PRICE_ID_EXACT = false;

	/**
	 * Слады
	 */
	public static boolean WH_QTY = false;

	/**
	 * Запрет фото камерой андроида
	 */
	public static boolean ANDROID_CAMERA_PROHIBIT = false;

	public static boolean USING_CAMERA_X = false;

	public static boolean USING_SCAN_FRAME = true;

	public static boolean HAVE_RETURN_DOC = false;


	/**
 	*Кнопка следующий пункт сценария
 	**/
	public static boolean SCRIPT_GO_NEXT = true;

	public static boolean CREATED_ORG_SHOW_ALL_DOCS = false;
