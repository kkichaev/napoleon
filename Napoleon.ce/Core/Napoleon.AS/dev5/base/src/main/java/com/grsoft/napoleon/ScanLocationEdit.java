...
public class ScanLocationEdit extends BaseSimpleActivity implements GpsStatus.Listener, GoogleMap.OnMarkerDragListener, ScriptActivity {
    ...
    public static void open(Context context, long rowid) {
        Intent i = new Intent(context, ScanLocationEdit.class);
    ...
    private OnClickListener sendClick() {
        return new OnClickListener() {
            ...
            public void onClick(View v) {
                new DocumentSender(v.getContext(), btnSend, DocType.getCurDoc().getObjectName(), document, document.getRowid()).execute((Void[]) null);
            }
        };
    }
