...
public class ReturnPriceCount extends PriceCount implements OrderImplBase.UpdateQtyHandler {
	...
	public static void open(Context context, long priceRowid, ReturnImpl doc) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (document != null && document instanceof ReturnImpl) {
	...
	protected void refreshData() {
		...
		if (document != null && document instanceof ReturnImpl) {
			...
			ReturnItem re = (ReturnItem) ((ReturnImpl)document).findItem(itemId);
	...
	class DlvAdapter extends BaseAdapter {
		...
		public void refresh(String orgId, String itemId) {
			 item = (ReturnItem) ((ReturnImpl)document).findItem(itemId);
			 if( item == null)
				 item = new ReturnItem();
