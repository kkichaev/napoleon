...
public class DocumentsW extends DocumentsBase implements Refreshable, WorkTimeListener.ClickHandler
{
	...
	static public void open(Context context, Org org) {
		...
		if(!Features.CREATED_ORG_SHOW_ALL_DOCS) {
			if( org.isPotencial() )
...
//	void updateHint() {
//		int vList = View.VISIBLE;
//		int vHint = View.GONE;
//		if(adapter.getCount() == 0) {
//			vList = View.GONE;
//			vHint = View.VISIBLE;
//		}
//		findViewById(R.id.lvDocs).setVisibility(vList);
//		findViewById(R.id.docs_hint).setVisibility(vHint);
//	}
