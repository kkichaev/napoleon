...
//	}
	...
	protected void initData(Context context, String orgId, GpsCoord gpsCoord){
		data.date = Util.getDateTime(); //Util.getDate();
	...
	public boolean initSilent(Context context, String orgId, GpsCoord gpsCoord){
		initData(context, orgId, gpsCoord);
	...
	public boolean init(Context context, String orgId, GpsCoord gpsCoord){
		return initSilent(context, orgId, gpsCoord);
	}
