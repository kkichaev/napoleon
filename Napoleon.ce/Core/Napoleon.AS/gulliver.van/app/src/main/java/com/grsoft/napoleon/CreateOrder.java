...
public class CreateOrder extends BaseActivity
{
	...
	private void init() {
		...
		createDogovorSpinner(this, o.dogCode, oe, dgvCache);
...
//		}
	...
	public static Spinner createDogovorSpinner(Activity activity, String dogCode, OrgEx oe, Map<String, OrgDogovor> dc) {
		int selected = -1;
		...
		if(dgvs != null)
			for(OrgDogovor od : dgvs) {
				...
				if(selected < 0 &&  kv.key.equals(dogCode)) {
					selected = index;
				}
