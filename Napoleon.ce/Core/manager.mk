...
FORMS=AckName AnswerOverview ChangePassword CheckAdmin DivisionChief Divisions \
 ...
 FmTaskAdd FmViewPhoto FmWait FmWelcome FmSVTask FmSetOrgColor FmRouteHistory \
 FmColorEditor FmScriptEdit ReturnOverview FmEditCateg FmProducer FmEditProducer FmQuestionReport FmCateg \
 Login OrderOverview MonitoringItems MonReportParams MainForm MoneyProxyDetail RemnantsOverview Route ScriptOverview SelectAgents \
 UserForm ViewException FmCoverArea DatePeriodView FmTaskReport WebViewWarning\
 WorkTimeParams FmRouteApproval FmApproveMsg FmScriptTimeRptParam FmUserLocation FmQuestAttach EdSpinner EdImage MatrixOrderEditor $(MANAGER_FORMS)
...
SOURCE=ArticlesTreeConstructor ArticlesTreeConstructorWithCondition CheckedComboBox FinderTreeNodesInList ClientCard Config ConfigHistory ConfigKeyItems \
...
PRG_ROOT=Napoleon.Net/NapoleonManager
...
VPATH := $(PRG_ROOT)/Forms.v3
SOURCE_PATH=$(ROOT)/$(PCORE)/$(PRG_ROOT)/Resources.v3
SRC_DIR+= Properties.v3
PROG_ICO=$(PRG_ROOT)/Resources.v3/napoleon.ico
endif
