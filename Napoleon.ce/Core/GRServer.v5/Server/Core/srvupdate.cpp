...
static const wchar_t AUTH_UPD_ERROR[] = L"�� ���������� ���� ��� �������� ����������";
static const wchar_t UPD_FORMAT_ERROR[] = L"������������ ������ ������ ����������";
static const wchar_t UPD_LOADED[] = L"��������� ��������� �� ������";
static const wchar_t NO_UPDATE[] = L"��� ����������";
static const wchar_t UPDATE_SERVER_ERROR[] = L"������ ��� ���������� �������";
...
bool FindLastUpdate(std::wstring *version, std::string *fileName, const std::string& folder, const std::wstring& category)
{
   ...
   //      if( fileName != NULL ) fileName->assign(W2A_CP(fn, CP_UTF8));
   //   }
...
Binary* LoadUpdatePacket(const std::wstring& param)
{
   ...
   //      fileName.append(W2A_CP(cat.c_str(), CP_UTF8));
   //      fileName.append(W2A_CP(ver.c_str(), CP_UTF8));
   //      fileName.append(".upd");
...
static bool UpdateServer(const std::string& updateFile, Session* session)
{
   ...
   if( CreateProcessA(upProg.c_str(), pBuf, NULL, NULL, FALSE, CREATE_NEW_PROCESS_GROUP, NULL, NULL, &si, &pi) )
   {
      ...
      gServer->AddError(false, "������ %d ��� ������ ��������� ���������� %s %s", GetLastError(), upProg.c_str(), pBuf);
...
//   bool done = false;
//
//   if( user->ObjectAllowed(L"", User::oaUpdate) == false )
//   {
