...
public:
   ...
   const Member* operator[](const std::wstring& name) const {
      return this->operator[](name.c_str());
   }

   Member* operator[](const std::wstring& name)  {
      return this->operator[](name.c_str());
   }
...
public:
   ...
   bool Read(Binary* buf, Socket* socket, DWORD timeout, HANDLE evStop, IServObjectCreator* creator, bool pushEmptyObjects = false);
