...
SOURCE=Config CostReader DataSource FieldBinder ObjSource ODBC Reader Selector Writer QuerySource dllmain
RESOURCE=ODBC
...
ADD_INCLUDE=../Include;Lib.pc/Include;Include;

VPATH:=Plugins/ODBC/Core
