...
#define GUI_FONTTYPE_PROP_EXT	2
#define GUI_FONTTYPE_MONO		3

typedef signed char I8;
typedef signed short I16P;
...
typedef struct _GUI_FONT
{
	...
	U8 width;			/* space of font y */
	U8 mgfX;			/* magnification x */
	U8 mgfY;			/* magnification y */
	const void* charProps;
	U8 baseLine;		/* Baseline */
	U8 lcHeight;		/* Height of lowercase characters */
	U8 capHeight;	/* Height of capital characters */
} GUI_FONT;
